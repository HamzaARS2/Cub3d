...
//     game->textures.north_texture = gfx_create_teximage(game->mlx, game->graphics, texpaths.north_tex);
//     game->textures.south_texture = gfx_create_teximage(game->mlx, game->graphics, texpaths.south_tex);
//     game->textures.east_texture = gfx_create_teximage(game->mlx, game->graphics, texpaths.east_tex);
//     game->textures.west_texture = gfx_create_teximage(game->mlx, game->graphics, texpaths.west_tex);
// }
...
//         tex_offset_y = (y - wallstrip_height) * ((float)game->textures.north_texture->height / wall_strip_height));
